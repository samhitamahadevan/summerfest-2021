...
<div>
<img src= "pairprogramming.png" height="495px" width="495px" style="position:absolute; left:10%; top:30%; border-style: solid;
  border-color:white;" >
</div>
            ...
            <form action="includes/ppadd.inc.php" method="post">
